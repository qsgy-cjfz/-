...
# input the absolute path of sourse file, any code using the macro
# would expose sensitive information, such as MORROR_THROW_EXCEPTION(x),
# so we'd better overwrite it with filename.
function(force_redefine_file_macro_for_sources targetname)
	get_target_property(source_files "${targetname}" SOURCES)
	foreach(sourcefile ${source_files})
		# Get course file's current list of compile definitions.
